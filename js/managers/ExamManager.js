...
class ExamManager {
  ...
  async deleteExam(examId) {
    ...
    try {
      // Supabase se puede configurar con 'cascade delete' para hacer esto automáticamente.
      // Si no, habría que borrar las preguntas y los intentos primero.
      ...
      this.loadExams(); // Recargar la lista
