  ...
  renderEditor() {
    ...
    this.container.innerHTML = `
      <div class="creator-toolbar">
        <button onclick="app.creator.showPresentationList()">< Volver a la lista</button>
        <input type="text" id="presentation-title-input" value="${this.app.utils.escapeHtml(this.currentPresentation.title)}" style="font-weight: bold; font-size: 1.2em; border: none; flex: 1;"/>
        <button onclick="app.creator.addTextElement()">+ Texto</button>
        <button onclick="app.creator.addImageElement()">+ Imagen</button>
        <button id="save-presentation-btn" class="secondary" onclick="app.creator.save()">Guardar</button>
      </div>
      <div class="creator-layout">
        <div class="slides-sidebar">
          ${slidesHtml}
          <button onclick="app.creator.addSlide()" style="width: 100%; margin-top: 10px;">+ Nueva Diapositiva</button>
        </div>
